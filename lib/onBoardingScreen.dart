...
class OnBoardingScreen extends StatelessWidget {
  final pages = [
    PageViewModel(
      ...
      body: Column(
        children: <Widget>[
          Text('Medical information', style: TextStyle(fontWeight: FontWeight.w900, color: Colors.white),),
          Text(
    ...
    PageViewModel(
      ...
      body: Column(
        children: <Widget>[
          Text('Uniqe Rescue code', style: TextStyle(fontWeight: FontWeight.w900, color: Colors.white)),
          Text(
    ...
    PageViewModel(
      ...
      body: Column(
        children: <Widget>[
          Text('Report Accidents', style: TextStyle(fontWeight: FontWeight.w900, color: Colors.white)),
          Text(
